...
const EditProfile = () => {
    ...
    const onSubmit = async (data) => {
        const { username, location, gender } = data;
        ...
        try {
            ...
            if (resumeFile) {
                ...
                updateUser.resume = uploadRes.data.resumeUrl;
            } else if (user?.resume) {
                updateUser.resume = user.resume;
            }
                    ...
                    <form autoComplete="off" onSubmit={handleSubmit(onSubmit)}>
                        <div className="profile-form">
                            ...
                            <div className="row">
                                ...
                                />
                                {user?.resume && (
                                    <span className="text-[11px] font-semibold text-green-600 mt-1 pl-1 tracking-wider">
                                        Currently saved: <a href={user.resume} target="_blank" rel="noreferrer" className="underline">View Resume</a>
                                    </span>
                                )}
                            </div>
                        ...
                        <div className=" mt-6 w-full flex justify-center">
                            <input
                                type="submit"
                                value={isUploading ? "Uploading..." : "update"}
