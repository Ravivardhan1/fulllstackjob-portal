        ...
        if (password !== confirmPassword) {
            ...
            try {
                ...
                Swal.fire({
                    ...
                    text: response?.data?.message || "Registered successfully. Please login.",
                    confirmButtonColor: "#3b82f6",
                });
                reset();
                navigate("/login");
            } catch (error) {
                const errMsg = error?.response?.data?.message || error?.response?.data || "Registration failed. Please try again.";
                Swal.fire({
                    icon: "error",
